...
def getWX(out_path: str,
    ...
    wx_dates = _getFilteredMonthDays(start_date, end_date, data_type, filter_month_days)
    ...
    # ### GET REQUESTED DATA
    arcpy.AddMessage('Submitting data request...')
    ...
    if len(responses) > 0:
        ...
        arcpy.AddMessage('No data was found for the dates provided.')
